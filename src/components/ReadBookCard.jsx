    ...
    return (
        <div className=" border p-2 mt-10 rounded-lg  ">
            <div className="hero-content justify-start items-start flex-col lg:flex-row">
                <div className='bg-base-200 rounded-xl w-[300px] h-[300px] flex items-center justify-center'>
                ...
                <div className="space-y-5">
                    ...
                    <div className="space-x-5">
                        ...
                        <Link to={`/bookDetails/${bookId}`} ><button className='px-4 py-2  bg-green-500 rounded-full text-white'>View Details</button></Link>
                    </div>
                </div>
            </div>
        </div>
